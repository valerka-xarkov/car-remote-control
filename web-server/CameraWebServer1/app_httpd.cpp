...
esp_err_t wheelHandler(httpd_req_t *req) {
    httpd_resp_set_type(req, "text/html");
    char*  buf;
    size_t buf_len;
    char variable[32] = {0,};
